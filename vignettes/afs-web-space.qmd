---
title: "Upload files to your U-M AFS web space"
format:
  html:
...
knitr:
  opts_chunk:
    ...
    echo: false
vignette: >
  %\VignetteIndexEntry{Upload files to your U-M AFS web space}
...
After uploading your files/folders to `Public/html/project`, they will be publicly available at:
...
- You **cannot upload or download files with only ssh**.
